...
class DynamicController(private val dynamicService: DynamicService) {
    ...
    @PostMapping(value = [USER_URL + "/dynamic/list"])
            //默认是0  获取的是班级的动态  1是全校
    ...
    @PostMapping(value = [USER_URL + "/dynamic/commitDynamicPic"])
            //默认是0  获取的是班级的动态  1是全校
...
//        return dynamic.jsonOk()
    ...
    @PostMapping(value = [USER_URL + "/dynamic/commitDynamicVideo"])
    ...
    @PostMapping(value = [USER_URL + "/dynamic/commitComment"])
    ...
    @PostMapping(value = [USER_URL + "/dynamic/commitLiked"])
